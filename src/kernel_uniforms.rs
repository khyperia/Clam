...
enum Meta {
    Int(&'static str, u64, fn(&mut KernelUniforms) -> &mut u32),
    Float(&'static str, f64, f64, fn(&mut KernelUniforms) -> &mut f32),
    Vec3(
        &'static str,
        Vector3<f64>,
        f64,
...
const UNIFORM_METADATA: &[Meta] = &[
    Meta::Vec3("pos", Vector3::new(0.0, 0.0, 5.0), 1.0, |s| &mut s.pos),
    Meta::Vec3("look", Vector3::new(0.0, 0.0, -1.0), 1.0, |s| &mut s.look),
    Meta::Vec3("up", Vector3::new(0.0, 1.0, 0.0), 1.0, |s| &mut s.up),
    Meta::Float("fov", 1.0, -1.0, |s| &mut s.fov),
    Meta::Float("focal_distance", 3.0, -1.0, |s| &mut s.focal_distance),
    Meta::Float("scale", -2.0, 0.5, |s| &mut s.scale),
    Meta::Float("folding_limit", 1.0, -0.5, |s| &mut s.folding_limit),
    Meta::Float("fixed_radius_2", 1.0, -0.5, |s| &mut s.fixed_radius_2),
    Meta::Float("min_radius_2", 0.125, -0.5, |s| &mut s.min_radius_2),
    Meta::Float("dof_amount", 0.01, -1.0, |s| &mut s.dof_amount),
    Meta::Float("bloom_amount", 0.1, -0.25, |s| &mut s.bloom_amount),
    Meta::Float("bloom_size", 0.01, -0.25, |s| &mut s.bloom_size),
    Meta::Float("fog_distance", 10.0, -1.0, |s| &mut s.fog_distance),
    Meta::Float("fog_brightness", 1.0, -0.5, |s| &mut s.fog_brightness),
    Meta::Float("sky_brightness", 1.0, -0.5, |s| &mut s.sky_brightness),
    Meta::Float("surface_color_variance", 0.0625, -0.25, |s| {
        &mut s.surface_color_variance
    }),
    Meta::Float("surface_color_shift", 0.0, 0.125, |s| {
        &mut s.surface_color_shift
    }),
    Meta::Float("surface_color_saturation", 0.75, 0.125, |s| {
        &mut s.surface_color_saturation
    }),
    Meta::Float("surface_color_value", 1.0, 0.125, |s| {
        &mut s.surface_color_value
    }),
    ...
    Meta::Float("de_multiplier", 0.9375, 0.125, |s| &mut s.de_multiplier),
    Meta::Float("max_ray_dist", 16.0, -0.5, |s| &mut s.max_ray_dist),
