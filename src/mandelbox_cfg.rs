...
impl MandelboxCfg {
    fn get_f32_mut<'a, 'b>(&'a mut self, key: &'b str) -> Option<&'a mut f32> {
        let val = match key {
            ...
            "light_brightness_1_hue" => &mut self.light_brightness_1_hue,
            "light_brightness_1_sat" => &mut self.light_brightness_1_sat,
            "light_brightness_1_val" => &mut self.light_brightness_1_val,
            "ambient_brightness_hue" => &mut self.ambient_brightness_hue,
            "ambient_brightness_sat" => &mut self.ambient_brightness_sat,
            "ambient_brightness_val" => &mut self.ambient_brightness_val,
